...
<html>
  ...
  <body class="brown">
    <%
      ...
      ResultSet listado = s.executeQuery ("SELECT COUNT(*) FROM monstruo WHERE eleMon = " + request.getParameter("eleMon"));
      listado.next();
      ...
      ResultSet listado2 = s.executeQuery ("SELECT * FROM monstruo WHERE eleMon = '" + request.getParameter("eleMon") + "'");
